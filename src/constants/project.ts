...
export const PROJECTS: z.infer<typeof projectSchema>[] = [
  {
    id: 1,
    name: 'Pixel Share',
    description: 'A WebSocket based file sharing application that allows users to share files with each other in real-time.',
  ...
  },
  {
    id: 2,
    name: 'Code Compiler',
    description: 'Web based multi-language code compiler that allows users to compile their code in various programming languages.',
  ...
  },
  {
    ...
    name: 'College Result',
    description:
      'College Result is a web application that allows students to view their college results, including grades, marks, and other relevant information.',
  ...
  },
  {
    ...
    description: 'A web application that allows users to test their WebRTC capabilities and learn how to use WebRTC in their projects.',
  ...
  },
  {
    id: 7,
    name: 'Op Blog',
    description: 'A web based blogging app that allows user to create and publish blog posts using Markdown.',
  ...
  },
  {
    id: 10,
    name: 'Suduko Solver',
    description: 'A Sudoku puzzle solver web application that allows users to solve Sudoku puzzles using a graphical user interface.',
